...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (_jsx("th", { ref: ref, className: cn("h-8 px-2 text-left align-middle text-sm font-semibold text-muted-foreground/60 [&:has([role=checkbox])]:pr-0", className), ...props })));
TableHead.displayName = "TableHead";
const TableCell = React.forwardRef(({ className, ...props }, ref) => (_jsx("td", { ref: ref, className: cn("px-2 py-1.5 align-middle [&:has([role=checkbox])]:pr-0", className), ...props })));
